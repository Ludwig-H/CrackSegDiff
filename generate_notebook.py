  ...
  "cells": [
    ...
    },
    {
      ...
      "source": [
        ...
        "            \n",
        "            # Check empty channels 4 & 5\n",
        "            if orig.shape[2] >= 6:\n",
        "                mean_ch4 = orig[...,4].mean()\n",
        "                mean_ch5 = orig[...,5].mean()\n",
        "                print(f\"Channel 4 Mean: {mean_ch4:.2f}\")\n",
        "                print(f\"Channel 5 Mean: {mean_ch5:.2f}\")\n",
        "        else:\n",
    ...
    },
    {
      ...
      "source": [
        ...
        "\n",
        "            # 2. Intensity -> Channel 3\n",
        "            fused[..., 3] = img_i if img_i.ndim==2 else img_i[...,0]\n",
        "\n",
        "            # 3. Padding (Constant 100 as observed)\n",
        "            fused[..., 4] = 100\n",
        "            fused[..., 5] = 100\n",
        "\n",
